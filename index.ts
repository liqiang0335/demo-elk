...
const mock_4 = () => `/116.147.11.22:64873 - {"header":{"msgId":${Date.now()},"msgType":"request","subType":"upload"},"device":{"gatewaySn":"MA250201"},"payload":{"dataType":"compactness","dataList":[{"data":[2878,3179,3040,3126],"channelState":[1,1,1,1],"time":1743263948000}],"sn":"CF250203","bat":81}}`
const mock_5 = () => `/116.147.11.22:64874 - {"header":{"msgId":${Date.now()},"msgType":"request","subType":"upload"},"device":{"gatewaySn":"MA250201"},"payload":{"dataType":"compactness","dataList":[{"data":[2878,3179,3040,3126],"channelState":[1,1,1,1],"time":1743263948000}],"sn":"CF250203","bat":81}}`

const mockData = [mock_1, mock_2]
  .map((item, index) => {
